...
@test "MQTT retain persistence across reboots" {
    ...
    run docker run --network='host' hivemq/mqtt-cli pub -v -h localhost -p 80 -ws -ws:path mqtt -t anything/anything -m "Hello World!" --retain
